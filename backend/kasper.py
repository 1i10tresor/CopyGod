...
async def modify_order(message, message_id, is_pending):
    print("Début des 20 secondes")
    await asyncio.sleep(15)
    print("Fin des 20 secondes")
    try:  # modified
        ...
        if message_id == message_id_signal + 1:
            ...
            logger.warning(f"ID de message non séquentiel: attendu {message_id_signal + 1}, reçu {message_id}")  # modified
